...
1. قم بالتمرير إلى أسفل التعليمات البرمجية JSON في علامة التبويب **Result**. لاحظ أن نموذج القراءة قد اكتشف لغة كل فترة. معظم الفواصل باللغة الألمانية (رمز اللغة `de`) ولكن يمكنك العثور على رموز لغوية أخرى في الفواصل (على سبيل المثال، اللغة الإنجليزية - رمز اللغة `en` - في أحد الفترات الأخيرة).
