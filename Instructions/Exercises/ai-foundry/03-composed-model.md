...
1. في القائمة المنسدلة **ذكاء المستند أو مورد الخدمة المعرفية،** حدد **DocumentIntelligence&lt;xxxx&gt;**.
1. في القائمة المنسدلة **إصدارAPI،** تأكد من تحديد **(إصدار أولي) 31-07-2024،** ثم حدد **متابعة**.
...
1. حدد **تشغيل الآن** ضمن قائمة *تخطيط التشغيل* في النافذة المنبثقة *بدء وضع العلامات الآن،* وانتظر حتى يكتمل التحليل.
...
1. كرر عملية وضع العلامات للنماذج المتبقية في القائمة على اليمين، باستخدام التصنيفات التي قمتَ بإنشائها. قم بتسمية الحقول الأربعة نفسها: *FirstName* و*LastName* و*City* و*State*. لاحظ أن أحد المستندات لا يحتوي على بيانات المدينة أو الولاية.
...
1. في استوديو ذكاء المستندات بواسطة الذكاء الاصطناعي في Azure، حدد **تدريب**.
...
1. في الصفحة **Review and create**، حدد **Create project**.
1. حدد زر القائمة المنسدلة لـ **تخطيط التشغيل** وحدد **المستندات غير المٌحللة**.
1. انتظر حتى يكتمل التحليل.
...
1. كرر عملية وضع العلامات للنماذج المتبقية في القائمة على اليسار. قم بتسمية الحقول الأربعة نفسها: *FirstName* و*LastName* و*City* و*State*. لاحظ أن مستندين من المستندات لا يحتويان على أي بيانات اسم للتسمية.
...
الآن بعد اكتمال النموذج، دعنا نختبره باستخدام نموذج مثال:

1. في استوديو ذكاء المستندات بواسطة الذكاء الاصطناعي في Azure، حدد صفحة**النماذج**، ثم حدد **1040FormsModel**.
1. حدد **اختبار**.
